...
- [How Airbnb designs for trust](https://www.youtube.com/watch?v=16cM-RFid9U)
...
### HTTP
 ...
 -[http로 설명하는 쿠키](https://www.daleseo.com/http-cookies/)
...
- [GET, POST 의 차이](https://velog.io/@songyouhyun/Get%EA%B3%BC-Post%EC%9D%98-%EC%B0%A8%EC%9D%B4%EB%A5%BC-%EC%95%84%EC%8B%9C%EB%82%98%EC%9A%94)
...
- [AWS Lambda, DynamoDB 서버리스 컴퓨팅](https://ukayzm.github.io/aws-lambda/)
- [Serverless.com](https://www.serverless.com/examples)
...
- [MSW NextJS](https://blog.logrocket.com/getting-started-with-mock-service-worker/)
- [서버 API가 아직인데요](https://stitchcoding.tistory.com/41)
- [MSW Mock API](https://dantechblog.gatsbyjs.io/posts/msw-mock-api/)
